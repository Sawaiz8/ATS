...
if st.session_state["authentication_status"]:
    ...
    if st.session_state["on_page"] is not None:
        ...
        elif "current_session_data" in st.session_state and st.session_state["on_page"][:-5].lower() in [cat.lower() for cat in st.session_state["current_session_data"]["category_data"].keys()]:
